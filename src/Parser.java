  ...
  public static void main(String [] args) throws ParseException, TokenMgrError
  {
    ...
    try
    {
      ...
      for (i = 0; i < empresa; i++)
      {
        ...
        System.out.printf("%d. %s\u005ct\u005ct%.2f\u005cn", i + 1, name [i], value [i]);
      }
...
/*________________________*/
  ...
  Token t, t1, t2, t3, t4, t5, t6;
    ...
    while (true) {
      ...
      while (true) {
        ...
        case TNAME:
          ...
          jj_consume_token(TLINK);
          jj_consume_token(THREF);
          t = jj_consume_token(TTEXT);
          jj_consume_token(FTEXT);
          jj_consume_token(TFCOL);
            s = s + t.image.trim() + "\u005ct";
          break;
        case TPRICE:
          jj_consume_token(TPRICE);
    ...
    jj_consume_token(FTABLA);
    jj_consume_token(FHTML);
    {if (true) return s;}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x70000,0x4000,0x1000,};
   }
